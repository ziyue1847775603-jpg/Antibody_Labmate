...
REQUIRED_RELEASE_PATHS = {
    ...
    "docker-compose.live-local-amd.yml",
    ...
    "docker/live/colabfold-amd/Dockerfile",
    "docker/live/colabfold-amd/entrypoint.sh",
    "docker/live/colabfold-amd/THIRD_PARTY_NOTICES.md",
    ...
    "docs/design_artifact_contract.md",
    "docs/rfantibody_integration.md",
    ...
    "tests/test_rfantibody_design.py",
}
